...
const phases: Phase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Category filters', done: false },
      { label: 'Sort by trending, newest, most copied', done: false },
  ...
  },
  {
    ...
    status: 'upcoming',
    items: [
      { label: 'Stripe checkout — monthly / yearly billing', done: false },
      { label: 'Pro plan: unlimited stored components', done: false },
      { label: 'Customer billing portal', done: false },
      { label: 'Upgrade prompt when free limit is reached', done: false },
    ],
  },
  {
    id: 'phase-4',
